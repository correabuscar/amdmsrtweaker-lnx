...
//  {22.0, 1.0875, 37}, //P0, boost
  ...
  {25.0, 1.1625, 31}, //untested in linux; this uses like 65Watts from PSU (and the DIS card is always disabled btw) [PSU that comes with Z575 is only 20V*4.5A=90Watts (made 2011.09) but it died(not during compiling but during just browsing!) like 2 weeks ago or so(was using a max 2.4Ghz for quite a few months during chromium compiling w/o problems though); luckily I'm using a 120W one]
